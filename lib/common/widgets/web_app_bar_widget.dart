                            ...
                            return MouseRegion(
                              onHover: (details) {
                                if (Provider.of<CategoryProvider>(context,
                                        ...
                                        .categoryList !=
                                    null) {
                                  _showPopupMenu(details.position, context,
                          ...
                          OnHoverWidget(
                            ...
                            child: Consumer<CartProvider>(
                                builder: (context, cartProvider, _) =>
                                    _ItemCountView(
                                      count: cartProvider.cartList.length,
...
class _ItemCountView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextHoverWidget(
        builder: (isHover) => Stack(clipBehavior: Clip.none, children: [
              Icon(
                icon,
                color: isHover
...
class _CategoryHoverWidget extends StatefulWidget {
  ...
  const _CategoryHoverWidget({Key? key, required this.categoryList})
      : super(key: key);
        ...
        child: Column(
            children: widget.categoryList!
                .map((category) => InkWell(
                      ...
                      child: TextHoverWidget(builder: (isHover) {
                        return Container(
                          padding: const EdgeInsets.symmetric(
                              vertical: Dimensions.paddingSizeExtraSmall,
