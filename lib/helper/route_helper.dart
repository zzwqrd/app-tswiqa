...
class RouteHelper {
  ...
  static const String orderWebPayment = '/order-mmmm-payment';
  ...
  static String getNewPassRoute(String? email, String token) =>
      '$resetPassword?email=${Uri.encodeComponent('$email')}&token=$token';
  ...
  static String getCheckoutRoute(double amount, double? discount, String? type,
          String code, String freeDelivery, double deliveryCharge) =>
  ...
  static final Handler _verificationHandler = Handler(
    ...
    return _routeHandler(
      ...
      session: params['data'][0] == 'null'
          ? null
          : utf8
              .decode(base64Url.decode(params['data'][0].replaceAll(' ', '+'))),
    ));
  });
    ...
    return _routeHandler(
      child: checkoutScreen ??
          CheckoutScreen(
            ...
            deliveryCharge:
                double.parse(utf8.decode(base64Decode(params['del_char'][0]))),
          ),
    );
  });
